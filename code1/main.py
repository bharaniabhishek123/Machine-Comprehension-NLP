...
tf.app.flags.DEFINE_integer("save_every", 10, "How many iterations to do per save.") #changed from 500
tf.app.flags.DEFINE_integer("eval_every", 10, "How many iterations to do per calculating loss/f1/em on dev set. Warning: this is fairly time-consuming so don't do it too often.") #changed from 500
